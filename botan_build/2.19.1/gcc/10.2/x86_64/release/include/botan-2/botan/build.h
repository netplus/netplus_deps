...
* 'configure.py --link-method=copy --prefix=./gcc/10.2/x86_64/release --disable-shared-library --cc-min-version=10.2'
*
* Target
*  - Compiler: g++ -fstack-protector -m64 -pthread -std=c++14 -D_REENTRANT -O3
*  - Arch: x86_64
*  - OS: linux
*/
...
#define BOTAN_VERSION_VC_REVISION "git:4f4a8f82130ae0b3a655688d41e5599f44b21fcd"
...
#define BOTAN_INSTALL_PREFIX R"(./gcc/10.2/x86_64/release)"
#define BOTAN_INSTALL_HEADER_DIR R"(include/botan-2)"
#define BOTAN_INSTALL_LIB_DIR R"(./gcc/10.2/x86_64/release/lib)"
