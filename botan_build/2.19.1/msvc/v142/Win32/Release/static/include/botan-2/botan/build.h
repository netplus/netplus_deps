...
* 'configure.py --os=windows --cpu=x86_32 --cc=msvc --prefix=./msvc/v142/Win32/Release/static --disable-shared-library'
*
* Target
...
#define BOTAN_INSTALL_PREFIX R"(./msvc/v142/Win32/Release/static)"
#define BOTAN_INSTALL_HEADER_DIR R"(include/botan-2)"
#define BOTAN_INSTALL_LIB_DIR R"(./msvc/v142/Win32/Release/static\lib)"
