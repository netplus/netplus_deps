...
* 'configure.py --os=windows --cpu=x86_32 --cc=msvc --prefix=./msvc/v142/Win32/Debug/static --disable-shared-library --debug-mode'
*
* Target
...
#define BOTAN_VERSION_VC_REVISION "git:f140889117dd9a1bc53548ae1f349220f0115ff9"
...
#define BOTAN_INSTALL_PREFIX R"(./msvc/v142/Win32/Debug/static)"
#define BOTAN_INSTALL_HEADER_DIR R"(include/botan-2)"
#define BOTAN_INSTALL_LIB_DIR R"(./msvc/v142/Win32/Debug/static\lib)"
