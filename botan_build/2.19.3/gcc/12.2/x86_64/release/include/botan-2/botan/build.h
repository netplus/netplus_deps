...
* 'configure.py --link-method=copy --prefix=./gcc/12.2/x86_64/release --disable-shared-library --extra-cxxflags=-std=c++14'
*
* Target
*  - Compiler: g++ -fstack-protector -m64 -pthread -std=c++11 -D_REENTRANT -O3 -std=c++14
*  - Arch: x86_64
*  - OS: linux
*/
...
#define BOTAN_INSTALL_PREFIX R"(./gcc/12.2/x86_64/release)"
#define BOTAN_INSTALL_HEADER_DIR R"(include/botan-2)"
#define BOTAN_INSTALL_LIB_DIR R"(./gcc/12.2/x86_64/release/lib)"
