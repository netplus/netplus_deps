...
* 'configure.py --prefix=./build_target/gcc/10.2/x86_64/release --disable-shared-library --link-method=copy'
*
* Target
...
#define BOTAN_INSTALL_PREFIX R"(./build_target/gcc/10.2/x86_64/release)"
#define BOTAN_INSTALL_HEADER_DIR R"(include/botan-2)"
#define BOTAN_INSTALL_LIB_DIR R"(./build_target/gcc/10.2/x86_64/release/lib)"
