...
* 'configure.py --disable-shared-lib --link-method=copy --prefix=./gcc/4.8/x86_64/release/'
*
* Target
...
#define BOTAN_INSTALL_PREFIX R"(./gcc/4.8/x86_64/release/)"
#define BOTAN_INSTALL_HEADER_DIR R"(include/botan-2)"
#define BOTAN_INSTALL_LIB_DIR R"(./gcc/4.8/x86_64/release/lib)"
