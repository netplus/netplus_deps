...
* 'configure.py --link-method=copy --prefix=./gcc/9.3.0/x86_64/release --disable-shared-library'
*
* Target
...
#define BOTAN_INSTALL_PREFIX R"(./gcc/9.3.0/x86_64/release)"
#define BOTAN_INSTALL_HEADER_DIR R"(include/botan-2)"
#define BOTAN_INSTALL_LIB_DIR R"(./gcc/9.3.0/x86_64/release/lib)"
