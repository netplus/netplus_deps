...
* 'configure.py --os=windows --cpu=x86_64 --cc=msvc --prefix=./msvc/v142/x64/Debug/static --disable-shared-library --debug-mode'
*
* Target
...
#define BOTAN_VERSION_VC_REVISION "git:675b642c31829e75c091defa160116aa52f9b4ed"
...
#define BOTAN_INSTALL_PREFIX R"(./msvc/v142/x64/Debug/static)"
#define BOTAN_INSTALL_HEADER_DIR R"(include/botan-2)"
#define BOTAN_INSTALL_LIB_DIR R"(./msvc/v142/x64/Debug/static\lib)"
